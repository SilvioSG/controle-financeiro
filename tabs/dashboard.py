...
def render(ctx):
    ...
    with col_g2:
        ...
        # Buscar todos os agrupamentos mensais do ano atual e do ano anterior (se cruzar)
        ...
        for i in range(5, -1, -1):
            ...
            # Buscar do dict agregado apropriado
            if a2 == ano_sel:
    ...
    with st.expander("🏆 Top 5 Gastos e Visão Anual", expanded=False):
        ...
        with col_annual:
            ...
            # Buscar todos os agrupamentos mensais do ano atual em uma única query
